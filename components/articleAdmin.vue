<template>
  ...
  export default {
    setup() {
      const articles = ref([
        { title: 'Artikel Pertama', description: 'Ini adalah deskripsi artikel pertama.', photo: '' },
        { title: 'Artikel Kedua', description: 'Ini adalah deskripsi artikel kedua.', photo: 'https://via.placeholder.com/150' }
      ]);
