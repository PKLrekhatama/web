<template>
  <div
    class="relative w-full max-w-4xl mx-auto overflow-hidden rounded-lg shadow-lg mt-5 mb-5"
    data-aos="zoom-in"
  >
    <!-- Slides -->
    <div
    ...
    >
      <span
        v-for="(slide, index) in slides"
        :key="index"
        class="w-4 h-2 md:w-4 md:h-2 Dots bg-opacity-50 hover:bg-opacity-100 cursor-pointer"
...
<style scoped>
.Dots {
  background-color: rgb(113, 171, 72);
}
</style>
