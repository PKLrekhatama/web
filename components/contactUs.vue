<template>
  <div class="con min-h-screen pt-5">
    ...
    <div class="container px-4 mx-auto p-8">
      <div class="mx-auto">
        <div
          class="max-w-md mx-auto px-8 py-6 bg-gray-100 rounded-lg shadow-lg shadow-gray-900/100"
        >
          ...
          <form>
            ...
            <button
              class="w-full bg-lime-500 text-gray-800 py-2 px-4 rounded-lg hover:bg-yellow-400 transition duration-300"
              type="submit"
            >
              Send Message
            </button>
              ...
              <ul class="example-2">
                <li class="icon-content">
                  <a
                    ...
                    aria-label="Whatsapp"
                    href="https://api.whatsapp.com/send?phone=62895336271115&text=selamat+anda+mendapatkan+mobil+seharga+RP+200.000"
                  >
